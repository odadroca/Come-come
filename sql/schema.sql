...
INSERT INTO meal_templates (id, name, translation_key, icon, sort_order) VALUES
    (1, 'Pequeno Almoço', 'meal.breakfast', '🍞', 1),
    (2, 'Lanche da Manhã', 'meal.morning_snack', '🍎', 2),
    (3, 'Almoço', 'meal.lunch', '🍝', 3),
    (4, 'Lanche da Tarde', 'meal.afternoon_snack', '🍪', 4),
    (5, 'Jantar', 'meal.dinner', '🍛', 5),
    (6, 'Lanche da Noite', 'meal.night_snack', '🥛', 6);

-- Seed data: Food catalog 
...
INSERT INTO i18n (locale, key, value) VALUES
    ...
    ('en-UK', 'confirm.vacuum', 'Optimize database? This may take a few seconds.'),
